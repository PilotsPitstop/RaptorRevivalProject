...
import net.PilotsPitstop.raptorrevivalproject.item.custom.*;
import net.PilotsPitstop.raptorrevivalproject.util.ModSoundEvents;

public class ModItems {

    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, RaptorRevivalProject.MOD_ID);


    public static final RegistryObject<Item> AMETHYST = ITEMS.register("amethyst",
            () -> new Item(new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP)));

    public static final RegistryObject<Item> FIRESTONE = ITEMS.register("firestone",
            () -> new Firestone(new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP).maxDamage(8)));
    ...
    public static final RegistryObject<Item> OATS = ITEMS.register("oats",
            () -> new BlockItem(ModBlocks.OATS.get(), new Item.Properties()
                    ...
                    .group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP)));
    ...
    public static final RegistryObject<Item> REDWOOD_SIGN = ITEMS.register("redwood_sign",
            () -> new SignItem(new Item.Properties().maxStackSize(16).group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP),
                    ModBlocks.REDWOOD_SIGN.get(), ModBlocks.REDWOOD_WALL_SIGN.get()));


    public static final RegistryObject<Item> OIL_BUCKET = ITEMS.register("oil_bucket",
            () -> new BucketItem(() -> ModFluids.OIL_FLUID.get(),
                    new Item.Properties().maxStackSize(1).group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP)));
    ...
    public static final RegistryObject<ModSpawnEggItem> VRAPTOR_SPAWN_EGG = ITEMS.register("vraptor_spawn_egg",
            () -> new ModSpawnEggItem(ModEntityTypes.VRAPTOR, 0xedc1b2, 0x575944,
                    new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP)));
    ...
    public static final RegistryObject<Item> KAUPENBOW = ITEMS.register("kaupenbow",
            () -> new BowItem(new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP).maxStackSize(1)));

    public static final RegistryObject<Item> KAUPENSTAFF = ITEMS.register("kaupen_staff",
            () -> new StaffItem(new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP).maxStackSize(1)));

    public static final RegistryObject<Item> REDWOOD_BOAT = ITEMS.register("redwood_boat",
            () -> new ModBoatItem(new Item.Properties().group(ModItemGroup.RAPTORREVIVALPROJECT_GROUP), "redwood"));
