package net.PilotsPitstop.raptorrevivalproject.commands;
...
public class ReturnHomeCommand {
    ...
    private int returnHome(CommandSource source) throws CommandSyntaxException {
        ...
        boolean hasHomepos = player.getPersistentData().getIntArray(RaptorRevivalProject.MOD_ID + "homepos").length != 0;

        if(hasHomepos) {
            int[] playerPos = player.getPersistentData().getIntArray(RaptorRevivalProject.MOD_ID + "homepos");
