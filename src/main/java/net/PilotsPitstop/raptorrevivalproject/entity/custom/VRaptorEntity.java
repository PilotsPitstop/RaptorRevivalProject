package net.PilotsPitstop.raptorrevivalproject.entity.custom;
...
public class VRaptorEntity extends ZombieEntity {
    public VRaptorEntity(EntityType<? extends ZombieEntity> type, World worldIn) {
        super(type, worldIn);
    }
