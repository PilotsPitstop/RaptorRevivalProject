package net.PilotsPitstop.raptorrevivalproject.world.biome;
...
public class ModBiomesDatapack {
    public static final DeferredRegister<Biome> BIOMES
            = DeferredRegister.create(ForgeRegistries.BIOMES, RaptorRevivalProject.MOD_ID);
    ...
    public static RegistryKey<Biome> registerBiome(String biomeName) {
        ...
        return RegistryKey.getOrCreateKey(Registry.BIOME_KEY, new ResourceLocation(RaptorRevivalProject.MOD_ID, biomeName));
    }
