package net.PilotsPitstop.raptorrevivalproject.world.structure;
...
import net.PilotsPitstop.raptorrevivalproject.world.structure.structures.HouseStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, RaptorRevivalProject.MOD_ID);
