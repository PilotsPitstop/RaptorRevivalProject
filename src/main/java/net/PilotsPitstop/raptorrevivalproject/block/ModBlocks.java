package net.PilotsPitstop.raptorrevivalproject.block;
...
import net.PilotsPitstop.raptorrevivalproject.block.custom.*;
import net.PilotsPitstop.raptorrevivalproject.block.custom.trees.RedwoodTree;
import net.PilotsPitstop.raptorrevivalproject.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS
            = DeferredRegister.create(ForgeRegistries.BLOCKS, RaptorRevivalProject.MOD_ID);
