package net.PilotsPitstop.raptorrevivalproject.block.custom;
...
import net.PilotsPitstop.raptorrevivalproject.container.LightningChannelerContainer;
import net.PilotsPitstop.raptorrevivalproject.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.raptorrevivalproject.lightning_channeler");
            }
